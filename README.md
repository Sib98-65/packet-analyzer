...
- *(Coming soon)* **Anomaly detection** using scikit-learn to flag potential port scans or unusual traffic bursts
...
6. *(Next)* Anomaly detection using scikit-learn (e.g., Isolation Forest) to flag possible port scans or traffic bursts
